...
public class ConfigManager {
    ...
    private long closeCommandDelayMs = 100; // Default 100ms delay for close-command actions
    ...
    private void createDefaultConfig() throws IOException {
        ...
        data._comment = java.util.List.of(
            ...
            "  command:cmd args     - Run a command (for commands that open their own UI)",
            "  close-command:cmd    - Close menu first, then run command (for teleports, etc.)",
            "",
            "Command examples:",
            "  command:vault        - Opens vault selector (vault has its own UI)",
            "  command:vault 1      - Opens vault #1 directly",
            "  close-command:spawn  - Close menu, then teleport to spawn",
            "  close-command:home   - Close menu, then teleport home",
            "",
    ...
    /**
     * Get the global close-command delay in milliseconds.
     * Used when a menu item doesn't have its own closeCommandDelayMs set.
     */
    ...
    private static class ConfigData {
        ...
        long closeCommandDelayMs = 100; // Global delay for close-command (ms)
