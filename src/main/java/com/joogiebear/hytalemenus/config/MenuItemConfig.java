...
public class MenuItemConfig {
    ...
    /**
     * Get the close-command delay override in milliseconds.
     * Returns null if not set (use global default from config).
     */
    ...
    /**
     * Check if this item has a custom close-command delay set.
     */
